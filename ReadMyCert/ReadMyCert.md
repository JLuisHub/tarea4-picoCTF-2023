...
Se descarga el archivo con con el enlace adjunto y se utiliza el siguiente comando

```bash
hone@unidad03:~$ openssl req -text -noout -verify -in readmycert.csr
verify OK
Certificate Request:
    Data:
        Version: 1 (0x0)
...
Bandera: picoCTF{read_mycert_a7163be8}
